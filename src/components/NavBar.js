...
const NavBar = () => {
    ...
    return (
        ...
        dark:text-light relative z-10 lg:px-16 md:px-12 sm:p-8'>
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://twitter.com/junaidali1014" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mr-3"
                    >
                    ...
                    <motion.a href="https://github.com/junaid-1013" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >
                    ...
                    <motion.a href="https://www.linkedin.com/in/junaid-ali-34b680243/" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >

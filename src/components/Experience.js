        ...
        <div className="my-64">
            ...
            <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
                ...
                <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
                    <Details
                        position="Math Teacher" company="The Quest School"
                        compayLink="http://thequestschool.edu.pk/"
                        time="Sep 2019- Januray 2020" address="Main G.T. Road, Shahdara Lahore"
                    ...
                    />
                    <Details
                        position="Math Teacher" company="Al-Ghazi Evening College"
                        compayLink="https://www.facebook.com/Ghazzians/"
                        time="Sep 2016- June 2019" address="Imamia Colony, shahdara Lahore"
                    ...
                    />
                    <Details
                        position="Math Teacher" company="Al-Farabi Group of Schools"
                        compayLink="https://ar-ar.facebook.com/alfarabigroupofschools/about/"
                        time="Aug 2018- Sep 2018" address="Imamia Colony, shahdara Lahore"
